...
@MediumTest
class NullableSerializerNullablePreferenceTest {

    companion object {

        private const val FILENAME: String = "pref_nullable_serializer_nullable"
        private const val VERSION_KEY: String = "arctic.pref.key.version"
        private const val PROPERTY_KEY: String = "key_boxedString"
    }

    private lateinit var serializerPreference: ArcticTernNullableSerializerNullablePreference
    ...
    fun `Test_default_value`() {
        ...
        Assert.assertTrue(serializerPreference.boxedString == null)
    }
